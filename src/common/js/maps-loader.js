...
(function (exports) {
    ...
    function initMaps(){
        ...
        maps.forEach(function (mapdom) {
            ...
            console.log(mapConfigObj.location.lat)

            // make a new map per object

            var myLatlng = new google.maps.LatLng(mapConfigObj.location.lat,mapConfigObj.location.lng);
            var mapOptions = {
            ...
            var map = new google.maps.Map(mapdom, {
                center: {lat: mapConfigObj.location.lat, lng: mapConfigObj.location.lng},
                zoom: Number(mapConfigObj.mapZoom),
                styles: mapConfigObj.theme == "Dark" ? darkStyles : []
            });*/
    ...
    function initMapScripts(){
        ...
        script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyC2MW4aCl4L8_eP7xTPAgOOCRIdgK1wCe0&callback=AmpCa.Utils.initMaps';
        script.defer = true;
